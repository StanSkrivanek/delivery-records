<script>
  ...
  let totals = $derived(() => {
    return records.reduce((/** @type {{ loaded: any; collected: any; cutters: any; returned: any; deliveryValue: number; collectedValue: number; totalValue: number; }} */ acc, /** @type {{ loaded: number; collected: number; cutters: any; returned: any; }} */ record) => {
